...
- Timestamp: `2022-07-07 11:23`
- Build ID: `bb79d8c8-2f78-4151-bcf0-65567089cbec`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bb79d8c8-2f78-4151-bcf0-65567089cbec.git
$ cd bb79d8c8-2f78-4151-bcf0-65567089cbec
```
